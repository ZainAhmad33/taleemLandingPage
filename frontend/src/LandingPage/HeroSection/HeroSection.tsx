  ...
  return (
    <AuroraBackground>
      ...
      >
        ...
        <button className="max-h-min bg-blue-800 text-md rounded-xl w-fit text-neutral-50 hover:text-neutral-900 dark:text-neutral-50/80 dark:hover:text-neutral-50 px-4 py-2" onClick={() => scrollToSection("waitlistSection")}>
        Sign Up Now!
        </button>
        </div>
      </motion.div>
